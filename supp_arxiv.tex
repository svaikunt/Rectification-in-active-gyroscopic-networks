...
We begin by writing the equation of motion of our system \eqnname~\eqref{eqn:GLE_single} in the form of a stochastic differential equation \eqnname~\eqref{eqnS:SDE_general}.
...
Our starting point is \eqnname~\eqref{eqn:flux_residue}. The key point is that, in the function $G^+(-i/\tau)$ from the equation, $\gamma,m,\tau$ are not independent factors. Rather, they act collectively through 
\begin{equation}
